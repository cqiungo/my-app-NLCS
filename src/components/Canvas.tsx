...
// export const App = ({ position = [0, 0, 2.5] as [number, number, number], fov = 25 }) => (
...
//     easing.dampC(shadows.current.getMesh().material.color, bgColor, 0.25, delta)
//   })
//   return (
//     <AccumulativeShadows
//       ref={shadows}
...
//   useFrame((state, delta) => easing.dampC((materials.lambert1 as THREE.MeshLambertMaterial).color, snap.color, 0.25, delta))
//   return (
//     <mesh castShadow geometry={(nodes.T_Shirt_male as THREE.Mesh).geometry} material={materials.lambert1} material-roughness={1} {...props} dispose={null}>
